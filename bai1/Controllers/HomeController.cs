using nguyenquangmanhasp.Models;
using System;
...
namespace nguyenquangmanhasp.Controllers
{
    public class HomeController : Controller
    {
        ...
        public JsonResult TestJsonResult()
        {
            ...
            {
                ID = 001,
                Name = "Nguyễn QuangHuy", ClassName = "C1311L" });
            listStudent.Add(new Student()
            {
                ID = 001,
            ...
            {
                ID = 001,
                Name = "Trần QuangHuy", ClassName = "C1311L" });
            listStudent.Add(new Student()
            {
                ID = 001,
            ...
            {
                ID = 001,
                Name = "Vũ QuangHuy", ClassName = "C1311L" });
            listStudent.Add(new Student()
            {
                ID = 001,
